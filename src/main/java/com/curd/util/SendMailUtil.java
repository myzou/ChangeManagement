...
public class SendMailUtil {
    ...
    private static final String PROTOCOL= LoadParameterUtil.PROTOCOL;
    private static final String DEBUG=LoadParameterUtil.DEBUG;
    private static final String myselfSendHost=LoadParameterUtil.myselfSendHost;
    private static final String myselfEmailPassword=LoadParameterUtil.myselfEmailPassword;
    private static final String myselfFormEmail=LoadParameterUtil.myselfFormEmail;
    private static final String dcSendHost=LoadParameterUtil.dcSendHost;
    private static final String dcFormEmail=LoadParameterUtil.dcFormEmail;
    private static final String dcEmailPassword=LoadParameterUtil.dcEmailPassword;
...
//            p.put("mail.smtp.host", "smtp.163.com");//邮件服务器的地址163
        ...
        log.info("邮件抄送件人："+JSONUtil.toJsonStr(cs));
        log.info("邮件包含附件地址："+JSONUtil.toJsonStr(fileList));
